...
log_file = os.path.join(log_dir, f'equiformer/qm9_{label_name}_training_log_{start_time}.log')
# log_file = os.path.join(log_dir, f'equiformer/test.log')
...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_equiformer.py',
