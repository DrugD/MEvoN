...
from model_gin_ablation import GNNModel
...
log_file = os.path.join(log_dir, f'ablation_gin_qm9_{label_name}_training_log_{start_time}.log')
...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_GIN_ablation.py',
    '/home/data1/lk/project/mol_tree/tools.py',
    '/home/data1/lk/project/mol_tree/model_gin_ablation.py',
