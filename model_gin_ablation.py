...
class GNNModel(nn.Module):
    def __init__(self, device):
        ...
        # self.fc1_1 = nn.Linear(512*3 + 512 + 64*5, 512)
        # self.fc1_1 = nn.Linear(512*3 + 64*5, 512)
        self.fc1_1 = nn.Linear(512*4, 512)
        ...
        self.layer_norm = nn.LayerNorm(512)  # 对512维进行标准化
    ...
    def forward_with_path(self, graph1, graph2, paths, paths_labels, paths_labels_masks):
        ...
        x_one = torch.cat([x12, x1, x2, path_features], dim=1)  # 将路径特征拼接
        # x_one = torch.cat([x12, x1, x2, path_labels_features], dim=1)  # 将路径特征拼接
