...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_gat.py',
...
# 初始化模型和优化器
# modify
device = torch.device("cuda:7" if torch.cuda.is_available() else "cpu") # cuda:0 cuda:1 cuda:2
# is_r2 = label_name == 'r2'
...
# 更改学习率之后 要更改对应的train predict infer的metrics3和loss  和  dataset_v2_test_Ha2eV.py中的target  crtl + f # modify