...
class GNNModel(nn.Module):
    def __init__(self, device):
        ...
        # 定义GINConv层
        self.conv1 = AntiSymmetricConv(in_channels = 90)
        self.fc_conv1 = nn.Linear(90, 128)
        self.conv2 = AntiSymmetricConv(in_channels = 128)
        self.fc_conv2 = nn.Linear(128, 256)
        self.conv3 = AntiSymmetricConv(in_channels = 256)
