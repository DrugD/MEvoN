...
class GNNModel(nn.Module):
    def __init__(self, device, is_r2=False):
        super(GNNModel, self).__init__()
        self.conv1 = GATConv(90, 128, heads=4, dropout=0.3) 
        self.conv2 = GATConv(128 * 4, 256, heads=4, dropout=0.3)  
        self.conv3 = GATConv(256 * 4, 256, heads=4, dropout=0.3)  
        self.conv4 = GATConv(256 * 4, 256, heads=1, dropout=0.3)
    ...
    def forward_origin(self, graph1):
        # 对第一个图进行卷积
