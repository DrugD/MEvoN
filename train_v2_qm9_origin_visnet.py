...
log_file = os.path.join(log_dir, f'only_Visnet_qm9_{label_name}_training_log_{start_time}.log')
...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_origin_visnet.py',
...
def train(model, train_dataloader, val_dataloader, optimizer, criterion, epochs=1000):
    ...
    for epoch in tqdm(range(epochs),desc=f'for {label_name}:'):
        ...
        if val_loss < best_val_loss:
            ...
            pth_file = os.path.join(checkpoint_dir, f'visnet_only_{label_name}_best_model_epoch_{start_time}.pth')
